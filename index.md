...
<section class="hero">
  <div class="container">
    <h1>I build the platforms other engineers build on.</h1>
    <p class="lede">
      I'm Olaf — a DevOps and platform engineering leader, 30 years in. Right now
      I'm moving a tier-1 investment bank off Bitbucket and Bamboo onto GitHub
      Enterprise, and standing up a Backstage developer platform for the UK's
