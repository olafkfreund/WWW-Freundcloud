...
## See Also
- [Bicep with GitHub Actions](bicep-with-github-actions.html)
- [Integrate Bicep with Azure Pipelines](integrate-bicep-with-azure-pipelines.html)
- [Bicep Template Specs](template-spec-for-bicep.html)
- [Use Inline Scripts with Bicep](use-inline-scripts.html)
- [Kubernetes Provider for Bicep](kubernetes-provider.html)
- [Loading Script Files in Bicep](load-script-file.html)
