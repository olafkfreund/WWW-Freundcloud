...
- [Installation Guide](installation.html) - Set up Copilot on different platforms
- [VS Code Integration](vscode-integration.html) - Get the most out of Copilot in VS Code
- [Command Line Usage](cli-usage.html) - Using the GitHub Copilot CLI
