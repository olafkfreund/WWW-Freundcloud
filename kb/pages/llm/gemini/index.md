...
- [Installation on Linux](installation-linux.html) - For standard Linux distributions
- [Installation on WSL](installation-wsl.html) - For Windows Subsystem for Linux users
- [Installation on NixOS](installation-nixos.html) - For NixOS users with declarative configuration

### Understanding Gemini Models

Learn about the capabilities of the latest Gemini models:

- [Gemini 2.5 Features, Pros and Cons](gemini-2-5-features.html)

### Advanced Integration

Take your Gemini usage to the next level:

- [Defining Roles and Agents](roles-and-agents.html) - Create specialized Gemini instances
- [NotebookML Guide](notebookml-guide.html) - Interactive infrastructure workflows with notebooks
- [Cloud Infrastructure Deployment](cloud-infrastructure-deployment.html) - Real-world deployment examples
...
For detailed guidance on using Gemini effectively, visit our [summary page](summary.html), which includes:
