...
- [Installation on Linux](installation-linux.html) - Step-by-step guide for setting up Gemini on Linux distributions
- [Installation on WSL](installation-wsl.html) - Instructions specific to Windows Subsystem for Linux environments
- [Installation on NixOS](installation-nixos.html) - Methods for adding Gemini to NixOS systems using the Nix package manager

## Gemini 2.5

- [Gemini 2.5 Features](gemini-2-5-features.html) - Detailed analysis of Gemini 2.5 capabilities, advantages, and limitations

## Custom Agents & Integrations

- [Roles and Agents](roles-and-agents.html) - How to define specialized Gemini agents for DevOps roles
- [NotebookML Guide](notebookml-guide.html) - Using NotebookML for interactive infrastructure management with Gemini
- [Cloud Infrastructure Deployment](cloud-infrastructure-deployment.html) - Real-world examples of deploying cloud infrastructure with Gemini
