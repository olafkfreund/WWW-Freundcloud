...
1. A working Ollama installation (follow the [installation guide](installation.html))
...
1. [Customize models](models.html) for specific use cases
2. [Optimize GPU acceleration](gpu-setup.html) for better performance
3. [Implement DevOps workflows](devops-usage.html) using the web interface
