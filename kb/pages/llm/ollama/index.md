...
1. [Installation Guide](installation.html) - Install Ollama on Linux, NixOS, or Docker
2. [Configuration](configuration.html) - Configure Ollama for optimal performance
3. [Models and Fine-tuning](models.html) - Details about available models and customization
4. [DevOps Usage Examples](devops-usage.html) - Real-world examples for DevOps engineers
5. [Docker Setup](docker-setup.html) - Running Ollama in Docker containers
6. [GPU Setup Guide](gpu-setup.html) - Configure GPU acceleration for NVIDIA, AMD, and Intel
7. [Open WebUI Integration](open-webui.html) - Adding a web interface to Ollama
...
For detailed instructions, please refer to the [Installation Guide](installation.html).
