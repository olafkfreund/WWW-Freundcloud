...
1. [Configure Ollama](configuration.html) for optimal performance
2. [Explore available models](models.html)
3. [Set up GPU acceleration](gpu-setup.html) for faster inference

For DevOps engineers, check out [DevOps Usage Examples](devops-usage.html) to see how Ollama can be integrated into your workflows.
