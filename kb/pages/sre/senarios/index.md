...
- [AWS VM Log Monitoring API](aws-vm-monitoring-api.html): Create a lightweight Golang-based API that exposes application logs from EC2 instances for monitoring systems
