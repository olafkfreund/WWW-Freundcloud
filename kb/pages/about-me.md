...
<figure><img src="../img/gitbook/PXL_20221014_102401611.PORTRAIT~2.jpg" alt="" width="188"><figcaption></figcaption></figure>
...
- **[Synechron ARC — Multi-Cloud Compliance Pipeline](showcase/synechron-arc.html)** — A customer demo platform wiring ServiceNow + Kosli + GitLab / GitHub / Azure DevOps into one auditable pipeline, deployable to AWS, Azure, GCP, or local k3d with a single `TARGET_CLOUD` switch. Ships with a Next.js DevSecOps control plane (37+ surfaces — DORA, SBOMs, control mapping, CMDB IRE sync, multi-cluster ArgoCD/Tekton, AI Governance, agent-dispatch automation). Full architecture write-up with screenshots in the [showcase](showcase/synechron-arc.html).
