...
[Here is an example](overview.html) of a threat modeling document which talks about the architecture and distinct phases involved in the threat modeling. This document can be used as reference template for creating threat modeling documents.
