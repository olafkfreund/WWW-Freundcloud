...
1. [Getting Started Guide](getting-started.html) - Install Kosli CLI and configure your first flow
2. [GitHub Actions Integration](github-actions.html) - Integrate Kosli with GitHub Actions
3. [GitLab CI Integration](gitlab-ci.html) - Integrate Kosli with GitLab CI/CD
4. [Azure DevOps Integration](azure-devops.html) - Integrate Kosli with Azure Pipelines
5. [CLI Reference](cli-reference.html) - Complete Kosli CLI command reference
6. [Best Practices](best-practices.html) - Proven patterns for Kosli implementation
...
- [DevOps Governance Overview](../index.html)
...
- [Azure DevOps →](azure-devops.html)

Or learn about [Kosli CLI commands →](cli-reference.html)
