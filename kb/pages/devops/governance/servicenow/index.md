...
- [GitLab Integration →](gitlab-integration.html) - GitLab CI/CD with ServiceNow REST API and webhooks
- [GitHub Actions Integration →](github-integration.html) - GitHub Actions with official ServiceNow actions
- [Azure DevOps Integration →](azure-devops-integration.html) - Azure Pipelines with ServiceNow extension
- [CI/CD Integration Overview →](cicd-integration-overview.html) - General patterns and concepts
...
- [CI/CD Best Practices](../../continuous-delivery/index.html)
- [Change Management Best Practices](best-practices.html)
...
[Get started with platform-specific integration →](cicd-integration-overview.html)
