...
- [Continuous Integration](../continuous-integration.html) - Core practices for automating code integration and testing 
- [Continuous Delivery](../continuous-delivery/index.html) - Principles and patterns for reliable software delivery
- [Azure DevOps](../../azure-devops/index.html) - Microsoft's enterprise DevOps platform
- [GitHub Actions](github/github-action.html) - GitHub's integrated CI/CD solution
- [ArgoCD](argo-cd/index.html) - GitOps continuous delivery for Kubernetes
- [DevSecOps](../../dev-secops/index.html) - Security integration in CI/CD workflows
- [Pipeline Observability](../observability/observability-of-ci-cd-pipelines.html) - Monitoring CI/CD performance
- [Testing Strategies](../testing/index.html) - Automated testing in CI/CD pipelines
