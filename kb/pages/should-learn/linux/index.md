...
- [Commands](commands/index.html): Essential Linux command-line tools (awk, jq, sed, ssh) with DevOps/cloud examples and automation tips.
- [Configuration](configuration/index.html): Guides for automating and managing Linux configuration, including cloud-init and NixOS declarative setups.
- [OS](os/index.html): Linux operating system concepts—permissions, file system hierarchy, tuning, sudo, and Bash shortcuts for DevOps/cloud workflows.
- [Services](services/index.html): How to enable, configure, and automate Linux services like RDP and tmux for cloud and hybrid environments.
